...
<el-card>
      <template #header>
        <div class="card-header">
          <span>采购合同管理</span>
          <el-button v-permission="'contract:create_purchase'" type="primary" @click="showCreateDialog = true">
            从采购订单生成合同
          </el-button>
        </div>
      </template>
      ...
      <el-table :data="list" border stripe v-loading="loading">
        ...
        <el-table-column label="操作" width="320" fixed="right">
          <template #default="{ row }">
            ...
            <el-button
              v-permission="'contract:approve_purchase'"
...
const guideConfig = { title: '采购合同操作指引', steps: [
        "创建采购合同",
        "提交审批",
        "审批通过后合同生效"
    ], tips: [
